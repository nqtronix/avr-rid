...
#if __has_include("config/rid_config.h")
	#include "config/rid_config.h"
#else
	#include "rid_config.h"
	#pragma message "rid: build-in configuration loaded, for custom settings see note rid_config.h"
#endif
